...
*
   ...
   * @youtube : https://www.youtube.com/@RhodvickTech

   * @infoription : Rhodvick-Md ,A Multi-functional whatsapp user bot.
...
await citel.send("Rhodvick-Md Injecting Malware")   
...
await citel.send(" RHODVICK MD SENDING LOG DOCUMENTS NOW...")    

await sleep(1000)

await citel.send(" RHODVICK MD SUCCESSFULLY SENT DATA AND Connection has Been Established")    
